...
function Profile() {
  ...
  return (
    <section>
      <Noticebar />
      <Headers />
      <div className="max-w-7xl mx-auto py-12 px-4 font-sans mt-28">
        <div className="flex gap-9">
          <button className="flex items-center gap-2 text-sm text-white mb-6 hover:underline px-3 py-1.5 bg-black rounded   ">
            <FaArrowLeft /> Back
          </button>
