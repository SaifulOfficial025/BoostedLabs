        ...
        <div className="bg-white rounded-xl shadow-lg max-w-md w-full p-8 relative">
          ...
          <div className="text-center">
            ...
            <div className="flex items-center justify-center gap-4 mt-6">
              <button
                className="bg-black text-white px-6 py-2 rounded font-medium text-base hover:bg-gray-900"
                onClick={onBack}
              >
                Back
              </button>
              <button
                className="bg-red-500 text-white px-6 py-2 rounded font-medium text-base hover:bg-red-600"
                onClick={onLogout}
              >
                Log Out
              </button>
