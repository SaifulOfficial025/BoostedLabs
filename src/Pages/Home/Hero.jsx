  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center max-w-3xl z-10 mx-auto sm:ml-8 md:ml-16 px-4 sm:px-0 text-center sm:text-left -mt-52 sm:mt-0">
        ...
        <p className="mt-4 text-base sm:text-xl md:text-2xl text-[#3a4a5c] mb-6">
          Science-backed peptides for healing, performance
          <br className="hidden sm:inline" />
          &amp; cosmetic wellness.
        </p>
        <button className="mt-4 sm:mt-5 bg-black text-white px-4 sm:px-10 py-2 sm:py-4 rounded-xl font-normal text-sm sm:text-md w-fit mx-auto sm:mx-0 flex items-center gap-2 transition-all duration-300 relative group shadow-none hover:shadow-[0_0_16px_2px_rgba(0,0,0,0.25)]">
